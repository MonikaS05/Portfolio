    ...
    <section id="journey" className="py-24 bg-void relative border-b border-bone/10 overflow-hidden">
      <div className="max-w-[1200px] mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          {/* Left Column: 24px Rounded Double-Border Frame */}
            ...
            <div className="relative w-full max-w-[260px] aspect-[3/4] p-1 border border-bone/15 rounded-3xl bg-transparent">
              <div className="w-full h-full overflow-hidden border border-plum-voltage/30 rounded-[20px] bg-void">
                <img 
                  ...
                  className="w-full h-full object-cover grayscale-[0.1] hover:grayscale-0 hover:scale-102 transition-all duration-700 ease-out"
                />
              </div>
